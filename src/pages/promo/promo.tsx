...
export const PromoPage = () => {
  ...
  const { cards, lists, functions, vars } = usePriceCards(rates, internalDebug.skeletonList);
          ...
          <div className='promo__content'>
            <div className='image__wrapper'>
              <div className='image__effect'>
                <ImageMemo path='/assets/images/to_be_2.png' alt='накачанный мужчина' externalConditions={!internalDebug.skeletonList} />
              </div>
            </div>
